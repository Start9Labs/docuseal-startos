...
- Fixes a crash when processing document images with unusual colour channels, such as CMYK or multi-band TIFFs.
...
- Corrige un fallo al procesar imágenes de documentos con canales de color poco habituales, como CMYK o TIFF multibanda.
...
- Behebt einen Absturz beim Verarbeiten von Dokumentbildern mit ungewöhnlichen Farbkanälen, etwa CMYK oder mehrkanaligen TIFFs.
...
- Naprawia awarię podczas przetwarzania obrazów dokumentów o nietypowych kanałach kolorów, np. CMYK lub wielokanałowych plików TIFF.
...
- Corrige un plantage lors du traitement d'images de documents comportant des canaux de couleur inhabituels, comme le CMJN ou les TIFF multibandes.
